    ...
    switch (msg) {
        case 'start':
            ...
            if (res.error instanceof Error) {
                ...
                self.postMessage({msg:'kill', id:e.data.id, data:res.error.message});
            } else {
                if (typeof res.symbols.start !== 'function') {
                    self.postMessage({msg:'kill', id:e.data.id, data:`Entry point static function 'start' missing!`});
                }
                start();
            }
            break;
