...
(function() {
    ...
    async function test_multichart() {
        ...
        ctrls_.push(new Ui.MultiChart('test1', config1, null, '/ui/multichart/shaders/test1'));
        ctrls_.push(new Ui.MultiChart('test2', { titlebar: 'Test2' }, null, '/ui/multichart/shaders/test1'));
        ...
        ctrls_[0].element.style.width = '640px';
